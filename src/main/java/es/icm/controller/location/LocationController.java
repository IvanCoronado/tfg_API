...
public class LocationController {
	...
	@ApiOperation(value = "Devuelve la lista de localizaciones del cliente seleccionado.", notes = "TODO:notes")
	@ApiResponses(value = {
	...
	public Page<LocationDTO> getLocations(@PathVariable(value = "idClient") int idClient) {
		return null;
	}
}
